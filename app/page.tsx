...
export default function Home() {
  ...
  return (
    <main ref={containerRef} className="min-h-screen bg-black text-white overflow-hidden">
          ...
          <PortfolioGrid
            items={[
              ...
              },
              {
                ...
                image: "/project/emersonmeadesite.png",
                link: "#home",
              },
            ]}
          />
      ...
      <ParallaxSection
        id="audio"
        className="py-20 bg-gradient-to-b from-blue-950 to-pink-950 relative"
        overlayImage="/images/brick-texture.png"
        scrollFactor={0.3}
      >
        <div className="container mx-auto px-4">
          <motion.h2
            ...
            viewport={{ once: true }}
          >
            <span className="text-blue-400">Audio</span> Engineering
          </motion.h2>
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8 max-w-4xl mx-auto">
            <AudioPlayer
              tracks={[
                {
                  title: "FL Studio Productions",
                  description: "Original music and beats created in FL Studio",
                  audioSrc: "/audio/track1.mp3",
                },
                {
                  title: "Mixing & Mastering",
                  description: "Professional audio mixing and mastering work",
                  audioSrc: "/audio/track2.mp3",
                },
              ]}
            />
            <motion.div
              className="bg-pink-900/30 backdrop-blur-sm rounded-xl p-6 flex flex-col justify-center border border-pink-800 relative overflow-hidden"
              initial={{ opacity: 0, y: 20 }}
              whileInView={{ opacity: 1, y: 0 }}
            ...
            >
              ...
              <h3 className="text-2xl font-bold mb-4">Audio Production Skills</h3>

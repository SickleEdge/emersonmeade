...
import { ChevronLeft, ChevronRight, Youtube, Instagram, TwitterIcon as TikTok } from "lucide-react"
  ...
  const contentItems = [
    {
      ...
      icon: <TikTok className="h-8 w-8 text-teal-500" />,
    ...
    },
    {
      ...
      image: "/images/instagram-content.png",
